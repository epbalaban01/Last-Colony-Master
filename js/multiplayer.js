var multiplayer = {
	...
	start:function(){
		...
		if (!WebSocketObject){
			game.showMessageBox("Tarayıcınız WebSocket özelliğini desteklemiyor. Çok oyunculu çalışmayacak.");
			return;
		}
		...
		this.websocket.onclose = function(){			
			multiplayer.endGame("Sunucuya bağlanırken hata oluştu.");
		}
	...
	join:function(){
	    ...
	    if(selectedRoom){            
	        ...
	        game.showMessageBox("Lütfen katılmak için bir oyun odası seçin.");            
	    }
	}, 
	cancel:function(){
