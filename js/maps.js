...
var maps = {
	"singleplayer":[
		{
			"name":"Rescue",
			"briefing": "Büyük savaştan bu yana geçen aylarda insanlık kaosa düştü. Milyarlarca harabe şehirlerde öldü.\nKüçük hayatta kalanlar grupları ellerinden geldiğince en iyi şekilde hayatta kalmaya çalışmak için bir araya geliyorlar. \nAna koloniye geri dönmeden önce bu sektördeki tüm kurtulanlara ulaşmaya çalışıyoruz.",
			...
			"triggers":[
			    {"type":"timed","time":3000,
			        "action":function(){
						game.showMessage("op", "Komutan !! Son konvoydan iki saattir haber alamadık. Şimdiye kadar gelmiş olmalılardı.");
			        }
			    },
			    {"type":"timed","time":10000,
			        "action":function(){
						game.showMessage("op", "En son Kuzey Batı Sektöründe görülmüşler. Araştırabilir misin");
			        }
			    },
			    {"type":"conditional",
			        "condition":function(){
			   ...
			   {"type":"conditional",
			        ...
			        "action":function(){
						game.showMessage("op", "Asiler son zamanlarda çok saldırganlaşıyor. Umarım konvoy güvendedir. Onları bulun ve üsse kadar onlara eşlik edin.");
			        }
			    },
				{"type":"conditional",
					"condition":function(){
				...
				{"type":"conditional",
					...
					"action":function(){
						game.showMessage("driver", "Biri bizi duyabiliyor mu? Konvoyumuz asi tankları tarafından saldırıldı. Yardıma ihtiyacımız var.");
					}
				},
				{"type":"conditional",
					"condition":function(){
					...
					"action":function(){
						var hero = game.getItemByUid(-1);
						game.showMessage("driver", "Teşekkür ederim. Buradan asla canlı çıkamayacağımızı düşündük.");
		...
		{
			"name":"Assault",
			"briefing": "Konvoydaki malzemeler sayesinde şimdi temelimiz hazır ve çalışıyor.\n Yakındaki isyancılar bir sorun teşkil ediyor. Onları dışarı çıkarmalıyız.  \n İlk önce temel savunma sistemini kur. Öyleyse bölgedeki bütün isyancıları bul ve yok et.\n Sömürge bize yardım etmemiz için takviye gönderecek.",
			...
			"triggers":[
				{"type":"timed","time":8000,
			        "action":function(){
						...
						game.showMessage("op", "Komutan !! Koloniden takviye geldi.");
				...
				{"type":"timed","time":25000,
			        "action":function(){
						// Supply extra cash
						game.cash["blue"] = 1500;
						game.showMessage("op", "Komutan !! Başka bir zemin tareti için yeterli kaynağımız var. Tabanı daha fazla saldırıya karşı korumak için tareti ayarlayın.");
			        }
			    },
				...
				{"type":"timed","time":180000,"repeat":true,
				    "action":function(){
						game.showMessage("op", "Komutan !! Daha fazla Güçlendirme geldi.");
		...
		{
			"name":"Under Siege",
			"briefing": "Sizin tarafınızdan yapılan saldırı sayesinde, asilerin üssünün kontrolü bizde. İsyancıların misilleme yapmaya çalışmasını bekleyebiliriz.\n Sömürge, ana kampa geri dönmemize yardımcı olmak için uçak gönderiyor. Tek yapmamız gereken, helikopterler gelene kadar sıkı durun. \n Neyse ki, onlar buraya gelinceye kadar kendimizi savunmak için bazı malzemelerimiz ve cephanemiz var. \n Taşımacılığı her ne pahasına olursa olsun koruyun.",
			...
			"triggers":[
				...
				{"type":"timed","time":5000,
			        "action":function(){
						game.showMessage("op", "Komutan !! İsyancılar saldırmaya başladı. Tabanı ne pahasına olursa olsun korumamız gerekiyor.");
			        }
			    },
				{"type":"timed","time":20000,
				    "action":function(){
						...
						game.showMessage("driver", "Komutan !! Koloni bazı ek malzemeler gönderdi. Kuzeydoğu sektöründen isyancı bir bölge üzerinden geliyoruz. Küçük bir koruma kullanabiliriz.");
				    }
				},
				...
				{"type":"timed","time":48000,
				    "action":function(){
						game.showMessage("driver", "Teşekkürler! Yedeklemeyi takdir edin. Tamam. Defol git.");
				...
				{"type":"conditional",
				    ...
				    "action":function(){
						game.showMessage("pilot", "Saldırı altındayız! Yardıma ihtiyacım var. Bu iyi görünmüyor ..");
				    }
				},
				...
				{"type":"conditional",
				    ...
				    "action":function(){
						game.showMessage("driver", "Asiler hiçbir yerden çıkmadı. Yapabileceğimiz hiç bir şey yoktu. Hayatımızı kurtardı. Umarım bu malzemeler buna değerdi.");
						game.cash["blue"] += 1200;
				    }
				},
		...
		if(heavyTankCount==0){
			...
			game.sendCommand([-21,-22],{type:"construct-unit",details:{type:"vehicles",name:"scout-tank","orders":{"type":"hunt"}}});
				...
				{"type":"timed","time":480000,
				    "action":function(){
						game.showMessage("op", "Komutan! Koloni hava filosu sadece birkaç dakika uzaklıktadır.");
				    }
				},
				//After 10 minutes send in reinforcements
				{"type":"timed","time":600000,
				    "action":function(){
						game.showMessage("op", "Komutan! Koloni hava filosu yaklaşıyor");
